"""
Django settings for kittygram2 project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Указываем путь к твоей папке
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'kittygram2.wsgi.application'
